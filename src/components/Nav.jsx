    ...
    <header className='main__header'>
      ...
      <div className="main__header__buttons">
        ...
        <div className='theme-mode'>
          {!darkTheme ?
            <button onClick={() => toggleDarkTheme()} title="Toggle theme">
        ...
        <div className="new-project">
          {
            newProject ?
              ...
              :
              <button className="create-new" onClick={() => { setNewProject(true); }} title="Create new">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi-plus-lg" viewBox="0 0 16 16">
